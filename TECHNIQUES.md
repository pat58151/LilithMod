...
| **Live information** | Intent-gated retrieval of current conditions, the next day's forecast, and web results, with metasearch, readable-page extraction, caching, and isolated untrusted context passed to the reply model. A forecast that comes back incomplete is dropped whole rather than reported as the wrong day. |
